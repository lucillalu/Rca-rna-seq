...
def paras_gene_dict(gene_dict, short_gene_dict, annotation_path):
    ...
    print("number of alternative splicing genes: " + str(len(list_AS)))
    print("number of single splicing genes: " + str(len(list_SS)))
    print("number of genes with short exons: " + str(len(list_short)))
...
def Get_Gene_Annotation(transcripts):
    ...
    for trans in transcripts:
        sig = 1
        for i in range(len(trans.exonitems)):
